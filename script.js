...
function create() {
  ...
  let text1 = this.add.bitmapText(200,100,{fontFamily: "dot", fontSize: "64px", color: "#ffffff"},'Build',64)
    .setTint(0x000000);
  let text2 = this.add.bitmapText(300,170,{fontFamily: "dot", fontSize: "64px", color: "#ffffff"},'Up!',64)
    .setTint(0x000000);
